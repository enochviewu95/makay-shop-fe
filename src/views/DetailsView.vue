<template>
  <div class="bg-white">
    <div class="pt-6">
      ...
      <!-- Image gallery -->
      <div
        class="mx-auto mt-6 max-w-2xl px-4 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8"
      >
        <div>
          <div
            class="aspect-w-3 aspect-h-4 overflow-hidden rounded-lg lg:block"
          >
            <img
          ...
          <div class="grid grid-cols-4 gap-3 my-4">
            <div
              class="aspect-w-3 aspect-h-2 overflow-hidden rounded-lg focus:border-sky-600 focus:border-2 hover:opacity-75"
            >
              <img
                :src="product.images[0].src"
                :alt="product.images[0].alt"
            ...
            <div
              class="aspect-w-3 aspect-h-3 overflow-hidden rounded-lg focus:border-sky-600 focus:border-2 hover:opacity-75"
            >
              <img
        ...
        <div class="mx-auto max-w-2xl pb-16 sm:px-6 lg:pb-24 lg:pl-8">
