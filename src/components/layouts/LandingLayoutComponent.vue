  ...
  <div class="isolate bg-white lander">
    <div>
      <div class="relative px-6 lg:px-8">
        <div class="mx-auto max-w-2xl py-20 sm:py-30 lg:py-40">
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div
              class="relative rounded-full py-1 px-3 text-sm leading-6 text-white ring-1 ring-gray-900/10 hover:ring-gray-900/20"
            >
