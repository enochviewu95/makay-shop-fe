<template>
  <div class="relative py-6 lg:py-28 lander flex justify-center lg:justify-end">
    <div
      class="relative my-10 w-80 lg:w-[30rem] lg:mr-12 rounded-xl bg-white p-6"
    >
...
<style scoped>
.lander {
  background-image: url("@/assets/images/shelf_clothes.jpg");
